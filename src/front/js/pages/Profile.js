...
export const Profile = () => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await fetch("https://ideal-guacamole-v6pq4wxxw5w4hrxj-3001.app.github.dev/api/users/1", {
                method: "GET",
                credentials: "include",
            });
    ...
    const handlePasswordChange = async () => {
        try {
            const response = await fetch("https://ideal-guacamole-v6pq4wxxw5w4hrxj-3001.app.github.dev/api/users/1/update-password", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
