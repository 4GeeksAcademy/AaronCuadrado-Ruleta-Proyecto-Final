...
# Clave secreta de Stripe (usar variable de entorno en producción)
...
endpoint_secret = 'whsec_osM6Tq6TZliF8HjxzwgbTTqvYTvucY1g'  # Secreto del webhook de Stripe
...
def stripe_webhook():
    ...
    # Responder a Stripe para confirmar la recepción del evento
    return '', 200
