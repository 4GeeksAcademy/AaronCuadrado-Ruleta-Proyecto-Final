...
#Configuracion de la clave de API de Stripe
...
def reserve_vehicle():
    ...
    stripe_session = stripe.checkout.Session.create(
        ...
        mode='payment',
        success_url='https://ideal-guacamole-v6pq4wxxw5w4hrxj-3000.app.github.dev/reserve-vehicle/success?booking_id=' + str(booking.id),
        cancel_url='https://ideal-guacamole-v6pq4wxxw5w4hrxj-3000.app.github.dev/reserve-vehicle/cancel',
        metadata={
            'user_id': session['user_id'],
